<script lang="ts">
	...
	const spacingTop = connectTop ? '' : 'pt-8';
	const spacingBottom = connectBottom ? '' : 'pb-8';
</script>
	...
	<div class="mx-auto max-w-6xl">
		<figure class="{sizeClasses[imageSize]} {alignmentClasses[alignment]}">
			{#if imageUrl}
				...
				/>
			{:else}
				<div class="flex h-64 items-center justify-center bg-primary-100 {roundedCorners ? 'rounded-xl' : ''}">
