...
<article class="bg-gradient-warm min-h-screen">
	<div class="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
		...
		<div class="rounded-xl bg-white p-8 shadow-lg md:p-12">
			...
			<!-- Excerpt -->
			{#if excerpt}
				<p class="mb-8 text-xl leading-relaxed text-primary-700 italic">
					{excerpt}
				</p>
			{/if}
			...
			<!-- Content -->
			{#if content}
				<div class="prose prose-sm max-w-none text-primary-900">
					<p class="mb-6 whitespace-pre-wrap leading-relaxed">
						{content}
					</p>
				</div>
			{/if}
			...
			<div class="mt-12 rounded-lg border-2 border-dashed border-primary-300 bg-primary-50 p-8 text-center">
